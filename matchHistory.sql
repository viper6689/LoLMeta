...
--
-- Host: localhost
-- Generation Time: Oct 09, 2015 at 06:25 PM
...
--
-- Table structure for table `dbVar`
--

CREATE TABLE IF NOT EXISTS `dbVar` (
  `globeVar` tinyint(2) unsigned NOT NULL DEFAULT '0'
...
--
-- Table structure for table `summonerMatchstats`
--

CREATE TABLE IF NOT EXISTS `summonerMatchstats` (
  `matchId` int(10) unsigned DEFAULT NULL,
  `summonerId` int(8) unsigned DEFAULT NULL,
  `championId` smallint(3) unsigned NOT NULL DEFAULT '0',
  `lane` set('MID','MIDDLE','TOP','JUNGLE','BOT','BOTTOM') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'TOP',
...
CREATE TABLE IF NOT EXISTS `teamHistory` (
  `matchId` int(10) unsigned DEFAULT NULL,
  `teamId` varchar(41) COLLATE utf8_unicode_ci DEFAULT NULL,
  `win` tinyint(1) NOT NULL DEFAULT '0',
  `kills` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `deaths` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `assists` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `opposingTeamName` varchar(30) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'unknown',
  `opposingTeamKills` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `invalid` tinyint(1) NOT NULL DEFAULT '0',
  UNIQUE KEY `matchId` (`matchId`,`teamId`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
